...
from apscheduler.triggers.cron.fields import (
    ...
    DEFAULT_VALUES as DEFAULT_VALUES,
    DayOfMonthField as DayOfMonthField,
    DayOfWeekField as DayOfWeekField,
...
from apscheduler.util import (
    ...
    datetime_ceil as datetime_ceil,
...
class CronTrigger(BaseTrigger):
    ...
    def __init__(
        ...
        week: Incomplete | None = None,
        day_of_week: Incomplete | None = None,
    ...
    @classmethod
    def from_crontab(cls, expr, timezone: Incomplete | None = None): ...
