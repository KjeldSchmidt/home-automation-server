...
class CeilingLightsCollection:
	def __init__(self, lamp_config: dict[str, list[str]], app: Flask, mqtt_client: MqttClient.Client):
	...
	def produce_main_page_content(self):
		return "<hr />".join([light.produce_main_page_content() for light in self.lights.values()])
